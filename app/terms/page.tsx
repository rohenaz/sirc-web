        ...
        <div className="prose prose-invert prose-zinc max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-400 leading-relaxed mb-4">
              By downloading, installing, or using SIRC, you agree to be bound
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-400 leading-relaxed mb-4">
              SIRC is open-source software distributed under the MIT License.
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-zinc-400 space-y-2 mb-4">
              ...
              <li>
                Compliance with the terms of service of IRC servers you connect
                to
              </li>
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-400 leading-relaxed mb-4">
              SIRC is provided "as is" without any warranties, express or
              implied. We do not guarantee that the software will be error-free,
