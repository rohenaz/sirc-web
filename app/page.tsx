  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-200 selection:bg-emerald-500/30">
      ...
      <section className="relative z-10 pt-24 pb-32 px-6 max-w-7xl mx-auto text-center">
        <Badge
          variant="outline"
          className="mb-6 border-emerald-500/30 text-emerald-400 bg-emerald-950/10 px-4 py-1 rounded-full font-mono text-xs"
        >
      ...
      <section
        id="features"
        className="relative z-10 py-24 bg-zinc-900/30 border-y border-zinc-800/50"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <Card className="bg-zinc-900 border-zinc-800 hover:border-emerald-500/30 transition-all duration-300">
            ...
            <CardContent className="space-y-4">
              ...
              <Progress
                value={68}
                className="h-2 bg-zinc-800 [&>*]:bg-orange-500"
              />
      ...
      <section id="faq" className="relative z-10 py-24 max-w-4xl mx-auto px-6">
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem
            value="item-1"
            className="bg-zinc-950 border border-zinc-800 rounded-xl mb-4 px-6"
          >
