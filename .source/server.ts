...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, }, {"features.mdx": __fd_glob_1, "index.mdx": __fd_glob_2, "installation.mdx": __fd_glob_3, });